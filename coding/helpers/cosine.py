...
def normalize_cosim(value, min_value=0.5, max_value=1.0, exponent=1.3):
    ...
    min_value (float): The minimum value of the original range. Default is 0.4.
    max_value (float): The maximum value of the original range. Default is 1.0.
    exponent (float): The exponent to be used for the normalization. Default is 2.

    Returns:
    float: The exponentially normalized value in the range of 0 to 1.
    """
